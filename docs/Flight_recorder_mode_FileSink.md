...
```
bin/spark-submit --master local[*] --packages ch.cern.sparkmeasure:spark-measure_2.13:0.28 \
--conf spark.extraListeners=ch.cern.sparkmeasure.FlightRecorderStageMetrics \
...
--packages org.apache.hadoop:hadoop-aws:3.4.2,ch.cern.sparkmeasure:spark-measure_2.13:0.28 \
