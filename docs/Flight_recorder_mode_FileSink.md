...
```
bin/spark-submit --master local[*] --packages ch.cern.sparkmeasure:spark-measure_2.12:0.22 \
--conf spark.extraListeners=ch.cern.sparkmeasure.FlightRecorderStageMetrics \
...
--packages org.apache.hadoop:hadoop-aws:3.3.2,ch.cern.sparkmeasure:spark-measure_2.12:0.22 \
