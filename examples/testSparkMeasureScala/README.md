...
bin/spark-submit --master local[*] --packages ch.cern.sparkmeasure:spark-measure_2.12:0.25 --class ch.cern.testSparkMeasure.testSparkMeasure <path_to_the_example_jar>/testsparkmeasurescala_2.12-0.1.jar
```
